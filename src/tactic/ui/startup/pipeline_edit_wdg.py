...
__all__ = ['PipelineEditWdg', 'SimplePipelineWdg', 'PipelineEditCbk', 'PipelineCreateCbk']
...
class PipelineEditWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        for pipeline in pipelines:
            pipeline_Div = SimplePipelineWdg(pipeline_code=pipeline_code)
...
class SimplePipelineWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        pipeline = Pipeline.get_by_code(my.kwargs.get('pipeline_code'))
        search_type = my.kwargs.get('search_type')
